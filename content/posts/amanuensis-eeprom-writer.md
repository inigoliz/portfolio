...
cover:
  ...
  relative: false
---
![(Amanuensis Header Art)](amanuensis_header.png#center "700px")
...
![(Reading EEPROM preview)](read_range_presentation.png#center "700px")
...
![(Ben's EEPROM programmer)](eater_setup.png#center "750px")
...
![(Binary program contents)](program.png#center "700px")
...
![(Gif showing EEPROM reading)](nuensis_read_alone.gif#center "700px")
...
![(Closeup of the mounted shield)](shield_full.jpeg#center "500px") 
...
![(Closeup of the mounted shield)](schema_2.png#center "650px") 
...
Let's see...
![(Weird behaviour of bytes())](bytes_weird.png#center "500px")
...
![(Byte string vs normal string)](bytes_strings.png#center "500px")
...
![(Reading serial data)](write_data.gif#center "500px")
...
![(Closeup of the shield)](shield.png#center)

![(Closeup of the shield)](shield_mounted.jpeg#center "400px")
